...
<!--- real example: 'SAD-16 Current Status in the Module Information page shows the binary values' -->
<!--- 'SAD-JiraIssueNumber JiraIssueTitle' -->
...
see https://issues.openmrs.org/browse/SAD-
